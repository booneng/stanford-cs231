...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out2, cache2 = max_pool_forward_fast(out1, pool_param)
        ...
        dout3, grads['W3'], grads['b3'] = affine_backward(dscores, cache4)
        grads['W3'] += self.reg * np.sum(W3)
        dout2, grads['W2'], grads['b2'] = affine_relu_backward(dout3, cache3)
        grads['W2'] += self.reg * np.sum(W2)
        dout2 = max_pool_backward_fast(dout2, cache2)
        dout1, grads['W1'], grads['b1'] = conv_relu_backward(dout2, cache1)
